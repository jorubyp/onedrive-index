...
const MarkdownPreview: FC<{
  ...
  const { response: content, error, validating } = useFileContent(`/api/raw/?path=${parentPath}/${file.name}&driveId=${driveId}`, path)
  ...
  const customRenderer = {
    ...
    img: ({
      ...
      return (
        ...
        <img
          alt={alt}
          src={isUrlAbsolute(src as string) ? src : `/api/?path=${parentPath}/${src}&driveId=${driveId}&raw=true`}
          title={title}
          width={width}
          height={height}
          style={style}
